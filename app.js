...
let activeInterestFilter = null; // 'sport' | 'cuisine' | 'art' | 'voyage' | null
...
function sendMsg() {
  ...
  typing.innerHTML = `
    <div class="typing-av"><img src="${chatProfile.photo}" alt="" style="width:100%;height:100%;object-fit:cover;border-radius:50%;"></div>
...
function updateSendBtn() {
  ...
  btn.className = 'chat-send' + (val ? ' ready' : '');
}
